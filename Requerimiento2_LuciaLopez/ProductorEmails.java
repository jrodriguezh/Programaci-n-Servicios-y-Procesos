...
public class ProductorEmails extends Thread {
	...
	// Propiedades productor: Nombre y buffer, por el que tiene que pasar para
	// guardar emails.
	...
	public void run() {
		// Creamos un objeto GeneradorEmails para llamar a su metodo generarEmails, que
		// al ser tipo Emails, nos devuelve el dato id
		...
		for (int i = 1; i <= 10; i++) {
			...
			// Imprimimos por pantalla cada vez que meta un email en el buffer su nombre y
			// el id del email metido
