...
public class Emails {
	// Los emails tendran un id, un destinatario, un remitente, un asunto y un
	// cuerpo del mensaje.
	private int id;
	...
	// Para que cada hilo tenga emails con id unico, creamos una variable estatica
	// que ira aumentando un numero cada vez que se genere un nuevo email.
	public int getId() {
		id = id_unico;
		id_unico++;
		return id;
