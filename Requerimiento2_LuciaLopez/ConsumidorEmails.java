...
public class ConsumidorEmails extends Thread{
	...
	/*Habra 2 hilos que consuman los emails del buffer siempre que haya email disponible. 
	  Cada vez que un consumidor coja un email, simular� su envio simplemente imprimiendo 
	  por pantalla los datos del email, as� como el nombre del hilo consumidor que ha cogido dicho email.*/
	...
	public void run() {
		...
		// Los consumidores coger�n emails siempre que haya disponibles en el buffer, por lo que creamos bucle while. 
		while(true) {
